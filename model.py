...
# Deconv 1
model.add(Conv2DTranspose(10, 3, 3, border_mode='valid', subsample=(1,1), activation = 'relu', 
                          output_shape = model.layers[8].output_shape, name = 'Deconv1'))
model.add(Dropout(0.2))

# Deconv 2
model.add(Conv2DTranspose(20, 3, 3, border_mode='valid', subsample=(1,1), activation = 'relu', 
...
# Deconv 3
model.add(Conv2DTranspose(30, 3, 3, border_mode='valid', subsample=(1,1), activation = 'relu', 
                          output_shape = model.layers[5].output_shape, name = 'Deconv3'))
model.add(Dropout(0.2))

# Deconv 4
model.add(Conv2DTranspose(40, 3, 3, border_mode='valid', subsample=(1,1), activation = 'relu', 
                          output_shape = model.layers[4].output_shape, name = 'Deconv4'))
model.add(Dropout(0.2))

# Deconv 5
model.add(Conv2DTranspose(50, 3, 3, border_mode='valid', subsample=(1,1), activation = 'relu', 
...
# Deconv 6
model.add(Conv2DTranspose(60, 3, 3, border_mode='valid', subsample=(1,1), activation = 'relu', 
                          output_shape = model.layers[1].output_shape, name = 'Deconv6'))

# Final layer - only including one channel so 1 filter
model.add(Conv2DTranspose(1, 3, 3, border_mode='valid', subsample=(1,1), activation = 'relu', 
